...
router.get("/mysql/payments", authenticate, bookingExtensionMySQLController.getAllPayments);
router.get("/mysql/bookings/:bookingId/payments", authenticate, bookingExtensionMySQLController.getPayments);
router.post("/mysql/bookings/:bookingId/payments", authenticate, bookingExtensionMySQLController.createPayment);
